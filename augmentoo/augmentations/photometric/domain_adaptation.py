...
from augmentoo.core.dtypes import get_opencv_dtype_from_numpy
from augmentoo.core.targets import is_grayscale_image, is_multispectral_image
...
class FDA(ImageOnlyTransform):
    ...
    Example:
        ...
        >>> aug = A2.Compose([A2.FDA([target_image], p=1, read_fn=lambda x: x)])
