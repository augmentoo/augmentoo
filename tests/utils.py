...
def get_filtered_transforms(
    ...
    for name, cls in inspect.getmembers(albumentations):
        if not inspect.isclass(cls) or not issubclass(
            cls, (augmentoo.BasicTransform, augmentoo.BaseCompose)
        ):
            continue
...
def get_image_only_transforms(
    custom_arguments: typing.Optional[typing.Dict[typing.Type[augmentoo.ImageOnlyTransform], dict]] = None,
    except_augmentations: typing.Optional[typing.Set[typing.Type[augmentoo.ImageOnlyTransform]]] = None,
) -> typing.List[typing.Tuple[typing.Type, dict]]:
    return get_filtered_transforms((augmentoo.ImageOnlyTransform,), custom_arguments, except_augmentations)


def get_dual_transforms(
    custom_arguments: typing.Optional[typing.Dict[typing.Type[augmentoo.DualTransform], dict]] = None,
    except_augmentations: typing.Optional[typing.Set[typing.Type[augmentoo.DualTransform]]] = None,
) -> typing.List[typing.Tuple[typing.Type, dict]]:
    return get_filtered_transforms((augmentoo.DualTransform,), custom_arguments, except_augmentations)


def get_transforms(
    custom_arguments: typing.Optional[typing.Dict[typing.Type[augmentoo.BasicTransform], dict]] = None,
    except_augmentations: typing.Optional[typing.Set[typing.Type[augmentoo.BasicTransform]]] = None,
) -> typing.List[typing.Tuple[typing.Type, dict]]:
    return get_filtered_transforms(
        (augmentoo.ImageOnlyTransform, augmentoo.DualTransform), custom_arguments, except_augmentations
    )
